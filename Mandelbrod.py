...
def MandelBrotAlgoritm():
    ...
    afbeelding.configure(image=None)
...
def paintPixel(xCoord, yCoord, MandelNumber, schaal, colorPattern, xMidden, yMidden):
    if(colorPattern==("zwart en wit")):
        if(MandelNumber%2==0):    
            draw.rectangle(((((((xCoord+xMidden)/schaal)),((yCoord+yMidden)/schaal))),(((((xCoord+xMidden)+1)/schaal)),(((yCoord+yMidden)+1)/schaal))), ((0), (0), (0)))
        else:        
            draw.rectangle(((((((xCoord+xMidden)/schaal)),((yCoord+yMidden)/schaal))),(((((xCoord+xMidden)+1)/schaal)),(((yCoord+yMidden)+1)/schaal))), ((255), (255), (255)))
